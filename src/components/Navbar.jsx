...
const Navbar = () => {
  ...
  return (
    ...
    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-500 bg-[#2d333b] '>
    <a className='flex justify-between items-center w-full text-gray-300'
    href="/">
    ...
    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-500 bg-[#347d39] '>
    <a className='flex justify-between items-center w-full text-gray-300'
    href="/">
